...
class Weapon(sprite_obj.AnimatedSprite):
    def __init__(self, game, path='resources/sprites/weapon/shotgun/0.png', scale=0.4, animation_time=90):
        ...
        self.weapon_pos = (settings.GAME.HALF_WIDTH - self.images[0].get_width() // 2, settings.GAME.SCREEN_HEIGHT - self.images[0].get_height())
    ...
    def animate_shot(self):
        if self.game.game_console.let_god_shoot:
