...
class NPC(sprite_obj.AnimatedSprite):
    ...
    def update(self):
        ...
        self.get_sprite()
        self.run_logic()
        self.ray_cast_player_npc()

        if self.game.game_console.view_raycast_enemy:
            self.draw_ray_cast()
    ...
    def check_hit_in_npc(self):
        if self.game.player.shot and self.ray_cast_value:
            if settings.GAME.HALF_WIDTH - self.sprite_half_width < self.screen_x < settings.GAME.HALF_WIDTH + self.sprite_half_width:
